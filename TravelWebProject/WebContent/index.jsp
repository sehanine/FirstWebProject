...
<%@ page language="java" contentType="text/html; charset=EUC-KR"
	...
	ArrayList<String> image_list = dao.getImage_list(i);
            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                        ...
                        for(int j=0;j<=dao.getImage_list(i).size()-1;j++){ 
                        %>
                        <img src="<%=image_list.get(j) %>" class="img-responsive" alt="Cabin">
                ...
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        ...
                        <div class="cycle-slideshow" cycle-slideshow data-cycle-loader="wait" data-cycle-timeout=1000>
                        <%
                        image_list = dao.getImage_list(i);
                         for(int j=0;j<=dao.getImage_list(i).size()-1;j++){ 
                        %>
                        <img src="<%=image_list.get(j) %>" class="img-responsive" alt="Cabin">
